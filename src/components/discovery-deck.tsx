      ...
      >
        <AnimatePresence>
          ...
          <motion.div 
            ...
            className="relative w-full h-full max-w-[400px] sm:max-h-[calc(100vh-12rem)] aspect-[9/16] sm:aspect-[2/3] active:cursor-grabbing" 
            drag
          ...
          >
            ...
            >
             ...
             <div className="absolute top-1/2 -translate-y-1/2 -right-20 md:-right-24 z-20 flex flex-col items-center gap-6">
                 <button 
                  onClick={handleLike}
