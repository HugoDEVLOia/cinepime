      ...
      <div>
        ...
        <Tabs defaultValue="stats" className="w-full">
          ...
          <TabsContent value="genres">
             ...
             <Card className="shadow-lg rounded-xl p-6 min-h-[300px] flex items-center justify-center">
                <Skeleton className="w-full h-64" /> {/* Chart Skeleton */}
             </Card>
          </TabsContent>
           <TabsContent value="actors">
             ...
             <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                {Array.from({length: 5}).map((_, i) => (
                    <Card key={i} className="p-3 shadow-md rounded-lg">
                        <Skeleton className="rounded-md aspect-[2/3] mx-auto mb-2 w-full"/>
